...
<body>
    <!-- Jumbotron -->
    <section class="bg-cover h-screen content-center text-white bg-center" style="background-image: url('img/rdr-bg.png');">
        <!-- Jumbotron container -->
    ...
    <!-- Services -->
    <section class="h-screen content-center md:h-fit serviceBG">
        <div class="serviceBG wrapper">
    ...
    <!-- Skills -->
    <section class="h-screen skillsBG">
        <div class="skillsBG wrapper">
    ...
    <!-- Contact -->
    <section class="h-screen contactBG">
    <div class="wrapper">
            <h1 class="text-4xl font-bold text-center pt-30">Contact</h1>
